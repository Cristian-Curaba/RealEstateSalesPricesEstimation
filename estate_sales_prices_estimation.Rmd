...
as '\_5' in the dataset). Also, with a visual inspection of the
`BuildingZIPCode`-`SalesPrices` relation, we note that some ZIP codes may be
really useful in predicting high sales values.
...
others (named $21$). Let's select all the indexes as specified above:
...
be improved by eliminating the collinearity. After developing the two models and
